 ...
 * 
 */
public class JavaLab06x03 {
    public static void main(String[] args){
        
        int a = UserInput.input("Enter number ");    //Enter number
        
        View.print("Reversed number is " + ReverseNumber.getReverseNumber(a) + "\n");   //reverse number and print reversed number
