...
public class Lab04B3 {
    public static void main(String[] args){
        ...
        double weightInKilogramms = ObjectWeight.getWeightInKIlos(weight);
        double weightInCenters = ObjectWeight.getWeightInCenters(weight);
        double weightInTons = ObjectWeight.getWeightInTons(weight);
