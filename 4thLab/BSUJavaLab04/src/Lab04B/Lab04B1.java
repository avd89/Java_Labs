...
public class Lab04B1 {
    public static void main(String[] args){
        ...
        double kilobytes = FileSizeCalculator.convertFileSizeFromBytesToKiloBytes(bytes);
        double megabytes = FileSizeCalculator.convertFileSizeFromBytesToMegaBytes(bytes);
        double gigabytes = FileSizeCalculator.convertFileSizeFromBytesToGigaBytes(bytes);
